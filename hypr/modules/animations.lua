...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 2.2, bezier = "easeOutQuint", style = "popin 92%" })
...
hl.animation({ leaf = "fadeOut", enabled = true, speed = 0.85, bezier = "almostLinear" })
...
hl.animation({ leaf = "fadeLayersOut", enabled = true, speed = 0.85, bezier = "almostLinear" })
